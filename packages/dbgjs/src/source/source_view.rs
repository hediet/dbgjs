...
use crate::capture::content_store::{ContentHash, ContentStore, ContentStoreStats, HashedBytes};
use crate::service::context_source_model::{ContextSourceModel, SourceContributionId, SourceSnapshotRole};
use crate::source::source_graph::{
    ...
    fn identity_source_is_the_resolved_view() {
        ...
        let routes = view
            .find_routes(
                ...
                crate::source::source_graph::RouteLimits::default(),
            )
            .unwrap();
