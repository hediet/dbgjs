...
pub use crate::source::source_effects::SymbolIndexCache;
use crate::source::source_view::{Position, ResolvedSourceView, SourceKind, canonical_source_uri};
...
mod tests {
    ...
    use crate::source::source_view::{GeneratedSourceInput, ResolutionPolicy};
