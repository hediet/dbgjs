...
pub struct ScriptState {
    ...
    pub provenance: crate::api::service_api::ScriptProvenance,
...
pub enum Input {
    ...
    ScriptParsedWithProvenance {
        ...
        hash: String,
        source_map_url: Option<String>,
        provenance: crate::api::service_api::ScriptProvenance,
    },
    RequestScriptSource {
        script: ScriptKey,
    },
        ...
        index.exact.insert(
            ...
            BreakpointSourceCandidate {
                ...
                content: ContentCandidate {
                    ...
                    provenance: crate::source::source_view::Provenance::RuntimeSource {
            ...
            for (source_url, content) in view.logical_sources.iter() {
                ...
                if source_urls_match(source_url, requested_source)
                    || source_map_url.is_some_and(|map_url| {
                        source_urls_match(
                            &crate::source::source_view::canonical_source_uri(Some(map_url), source_url)
                                .display(),
                            requested_source,
                        )
                    })
...
mod tests {
    ...
    fn authored_breakpoint_accepts_canonical_url_resolved_against_absolute_map() {
        ...
        let canonical = crate::source::source_view::canonical_source_uri(Some(map_url), logical).display();
            ...
            &ScriptState {
                ...
                source: ScriptSourceState::Resolved(SourceViewState {
                    ...
                    logical_sources: Arc::new(BTreeMap::from([(
                        logical.to_owned(),
                        ContentCandidate {
                            content: crate::capture::content_store::ContentStore::default().intern("widget"),
                            provenance: crate::source::source_view::Provenance::Workspace {
    ...
    fn formatted_projection_does_not_hide_exact_runtime_source_identity() {
        ...
        let candidate = ContentCandidate {
            content: crate::capture::content_store::ContentStore::default().intern("function runMapping(x) {}"),
            provenance: crate::source::source_view::Provenance::Formatted {
        ...
        let built = reduce(
            ...
            Input::SourceViewBuilt {
                ...
                logical_sources: BTreeMap::from([(
                    "src/app.ts".into(),
                    ContentCandidate {
                        content: crate::capture::content_store::ContentStore::default().intern("source"),
                        provenance: crate::source::source_view::Provenance::Workspace {
        ...
        let built = reduce(
            ...
            Input::SourceViewBuilt {
                ...
                logical_sources: BTreeMap::from([(
                    "app.ts".into(),
                    ContentCandidate {
                        content: crate::capture::content_store::ContentStore::default().intern("second"),
                        provenance: crate::source::source_view::Provenance::Workspace {
    ...
    fn ambiguous_source_candidates_are_bounded_without_mapping() {
        ...
        let store = crate::capture::content_store::ContentStore::default();
