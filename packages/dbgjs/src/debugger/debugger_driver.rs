...
use crate::debugger::cdp_runtime::{
...
use crate::debugger::debugger_engine::{DebuggerState, Effect, Input, SessionPhase, reduce};
...
use crate::source::source_effects::{SourceEffectError, SourceEffectInterpreter};
...
impl DebuggerDriver {
    ...
    pub(crate) async fn finish_heap_snapshot(
        &self,
    ) -> std::io::Result<crate::debugger::cdp_runtime::HeapSnapshotWriteResult> {
    ...
    pub fn logical_source_content(
        &self,
        script: &crate::debugger::debugger_engine::ScriptKey,
        source_url: &str,
    ) -> Option<Arc<str>> {
        self.sources
    ...
    pub fn project_generated_offset(
        ...
        script: &crate::debugger::debugger_engine::ScriptKey,
        utf16_offset: u32,
    ) -> Option<(String, crate::source::source_view::Position, Arc<str>)> {
        self.sources
    ...
    pub fn resolve_generated_position(
        ...
        script: &crate::debugger::debugger_engine::ScriptKey,
        position: crate::source::source_view::Position,
    ) -> Option<crate::source::source_location::ResolvedSourcePosition> {
        self.sources
    ...
    pub async fn acquire_script_source(
        &mut self,
        script: crate::debugger::debugger_engine::ScriptKey,
        control: Option<&crate::source::source_search::SearchControl>,
...
mod tests {
    use super::*;
    use crate::debugger::debugger_engine::{EffectId, ScriptKey, SessionKey};
