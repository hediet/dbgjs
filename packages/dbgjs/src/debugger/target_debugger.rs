...
use crate::capture::cpu::{
    ...
    cpu_profile_generated_location,
};
use crate::cdp::{
...
use crate::service::context_source_model::ContextSourceModel;
use crate::service::context_source_model::SourceContributionId;
use crate::debugger::debugger_driver::{DebuggerDriver, DebuggerDriverError};
...
use crate::capture::heap::heap_graph::{
...
use crate::capture::heap::heap_snapshot::{HeapConstructorGroup, parse_constructor_groups};
use crate::debugger::promise_debugging::{
...
use crate::source::source_effects::{SourceEffectInterpreter, SourceEffectOptions};
use crate::source::source_search::{HydratedSourceBatch, SearchControl, SearchError};
use crate::source::source_view::Position;
use crate::source::source_view::{GeneratedSourceInput, ResolutionPolicy, ResolvedSourceView};
...
pub struct TargetDebuggerHandle {
    ...
    session_id: String,
    heap_snapshot_progress: watch::Receiver<Option<crate::debugger::cdp_runtime::HeapSnapshotStreamProgress>>,
    raw_events: broadcast::Sender<crate::debugger::cdp_runtime::RawCdpEvent>,
    raw_event_history: Arc<std::sync::Mutex<Vec<crate::debugger::cdp_runtime::RawCdpEvent>>>,
}
...
impl TargetDebuggerHandle {
    ...
    pub fn subscribe_raw_events(&self) -> broadcast::Receiver<crate::debugger::cdp_runtime::RawCdpEvent> {
        self.raw_events.subscribe()
    }

    pub fn raw_event_history(&self) -> Arc<std::sync::Mutex<Vec<crate::debugger::cdp_runtime::RawCdpEvent>>> {
    ...
    pub async fn remove_logpoint(
        &self,
        breakpoint_id: String,
    ) -> Result<crate::api::service_api::LogpointRemovalResult, TargetDebuggerError> {
...
enum TargetCommand {
    ...
    RemoveLogpoint {
        breakpoint_id: String,
        response: oneshot::Sender<Result<crate::api::service_api::LogpointRemovalResult, TargetDebuggerError>>,
    },
    OwnsLogpoint {
        breakpoint_id: String,
        ...
        match next {
            ...
            Next::Command(Some(TargetCommand::RemoveLogpoint {
                ...
                let result = async {
                    ...
                    Ok(crate::api::service_api::LogpointRemovalResult {
                        existed: owned,
                        removed_bindings,
            ...
            Next::Command(Some(TargetCommand::SelectHeapNodes {
                ...
                let result = async {
                    ...
                    let mut inspector = crate::debugger::object_inspection::LiveSourceInspector::default();
            ...
            Next::Command(Some(TargetCommand::GetHeapReferences {
                ...
                let result = async {
                    ...
                    enrich_heap_live_source(
                        ...
                        &session_key,
                        &mut snapshot.node,
                        &mut crate::debugger::object_inspection::LiveSourceInspector::default(),
                    )
                    .await;
                    Ok(snapshot)
                }
            ...
            Next::Event(Err(error)) => {
                ...
                failed.log_capture.status = crate::api::service_api::LogCaptureStatus::Stopped;
...
struct StoredHeapCapture {
    ...
    source_resolver: Arc<std::sync::Mutex<crate::capture::heap::heap_locations::HeapSourceResolver>>,
}
...
impl HeapGraphView<'_> {
    ...
    fn node(&self, node: NodeIndex, max_string_length: Option<u32>,
        dominators: Option<&crate::capture::heap::heap_graph::DominatorAnalysis>,
...
fn heap_node_snapshot(
    ...
    Ok(HeapNodeSnapshot {
        ...
        string_value,
        string_truncated,
        preview: Some(crate::capture::heap::heap_preview::heap_preview(graph, node).map_err(heap_analysis_error)?),
...
fn heap_object_source(
    ...
    node: NodeIndex,
    capture: Option<&StoredHeapCapture>,
) -> Result<crate::debugger::object_inspection::ObjectSourceSnapshot, TargetDebuggerError> {
    capture
        .map(|capture| {
            capture
                .source_resolver
...
async fn enrich_heap_live_source(
    ...
    inspector: &mut crate::debugger::object_inspection::LiveSourceInspector,
) {
...
fn heap_reference_snapshot(
    graph: &HeapGraph,
    capture_id: &str,
    reference: crate::capture::heap::heap_graph::HeapReference<'_>,
    capture: Option<&StoredHeapCapture>,
    ...
    Ok(HeapReferenceSnapshot {
        ...
        source_preview: Some(
            crate::capture::heap::heap_preview::heap_preview(graph, reference.source)
                .map_err(heap_analysis_error)?,
        ),
        target_preview: Some(
            crate::capture::heap::heap_preview::heap_preview(graph, reference.target)
                .map_err(heap_analysis_error)?,
        ),
...
fn heap_path_step_snapshot(
    graph: &HeapGraph,
    capture_id: &str,
    step: crate::capture::heap::heap_graph::PathStep,
...
fn heap_analysis_error(error: crate::capture::heap::heap_graph::AnalysisError) -> TargetDebuggerError {
    TargetDebuggerError::HeapAnalysis(error.to_string())
}

fn heap_snapshot_timing(
    written: &crate::debugger::cdp_runtime::HeapSnapshotWriteResult,
) -> HeapSnapshotTiming {
    HeapSnapshotTiming {
...
async fn take_heap_snapshot(
    ...
    expose_internals: bool,
    progress: &mpsc::Sender<HeapSnapshotProgress>,
) -> Result<crate::debugger::cdp_runtime::HeapSnapshotWriteResult, TargetDebuggerError> {
    driver
...
async fn forward_heap_snapshot_progress<F, T, E>(
    updates: &mut watch::Receiver<Option<crate::debugger::cdp_runtime::HeapSnapshotStreamProgress>>,
...
fn heap_snapshot_progress(
    progress: crate::debugger::cdp_runtime::HeapSnapshotStreamProgress,
...
async fn send_finished_heap_snapshot_progress(
    updates: &watch::Receiver<Option<crate::debugger::cdp_runtime::HeapSnapshotStreamProgress>>,
    output: &mpsc::Sender<HeapSnapshotProgress>,
    bytes_written: u64,
) -> Result<(), TargetDebuggerError> {
...
struct ProjectedHeapClass {
    ...
    instance_count: u64,
    shallow_size: u64,
    instances: Vec<crate::capture::heap::heap_snapshot::HeapInstanceRecord>,
}
...
fn captured_heap_script(
    key: &ScriptKey,
    script: &crate::debugger::debugger_engine::ScriptState,
) -> HeapScriptSnapshot {
...
fn heap_source_view(script: &HeapScriptSnapshot, map: &str) -> Result<ResolvedSourceView, String> {
    ...
    if let Some(error) = view
        ...
        .find_map(|diagnostic| match diagnostic {
            crate::source::source_view::SourceDiagnostic::SourceMapFailed { error, .. } => Some(error),
            _ => None,
        })
    {
...
pub(crate) async fn prepare_heap_view_sources(
    mapping: Option<&HeapMappingSnapshot>,
) -> (crate::capture::capture_projection::PreparedViewSources, Vec<String>) {
...
pub(crate) fn recover_heap_mapping_for_view(
    mapping: Option<HeapMappingSnapshot>,
    prepared: &crate::capture::capture_projection::PreparedViewSources,
    diagnostics: &[String],
    ...
    for index in 0..mapping.scripts.len() {
        ...
        let recovered = prepared.get(&(script.script_id.clone(), script.url.clone()))
            ...
            .unwrap_or_else(|| crate::capture::capture_projection::recover_source_map_for_view(
                &script.url,
...
fn project_heap_classes(
    ...
    let mut symbol_indexes = BTreeMap::<String, crate::source::source_location::SymbolIndexCache>::new();
    for group in groups {
        ...
        let mapped = views.get(&script_id).map(|view| {
            let resolved = crate::source::source_location::resolve_source_position(
                view,
                &generated_url,
...
fn capture_script_provenance(script: &crate::debugger::debugger_engine::ScriptState) -> CaptureScriptProvenance {
    CaptureScriptProvenance {
    ...
    let snapshot = match result {
        Ok(result) => {
            ...
            if let Some(object_id) = &result.remote.object_id {
                preview.source = crate::debugger::object_inspection::LiveSourceInspector::default()
...
fn require_pause<'a>(
    ...
    session_key: &SessionKey,
    pause_epoch: u64,
) -> Result<&'a Arc<crate::debugger::debugger_engine::PauseState>, TargetDebuggerError> {
    let session = driver
        .state()
        .sessions
        .get(session_key)
        ...
        for (frame, raw_frame) in pause.frames.iter_mut().zip(raw_pause.frames.iter()) {
                    ...
                    driver.logical_source_content(&raw_frame.raw_script, &location.source_url)
            {
                frame.breadcrumb = callback_aware_breadcrumb(
                    crate::source::language_intelligence::breadcrumb(
                        &location.source_url,
                        &content,
                        location.line,
                        location.column,
...
fn breakpoint_candidate_snapshot(
    ...
    {
        crate::source::source_view::canonical_source_uri(source_map_url, &candidate.source_url).display()
    } else {
...
mod tests {
    fn representative_stored_graph() -> super::StoredHeapGraph {
        ...
        StoredHeapGraph {
            ...
            capture: StoredHeapCapture {
                ...
                mapping: crate::api::service_api::HeapMappingSnapshot {
                    connection_generation: 0,
                    scripts: Vec::new(),
                    hydration_duration_micros: 0,
                },
    ...
    use crate::debugger::cdp_runtime::CdpConnection;
    ...
    use crate::capture::heap::heap_snapshot::HeapConstructorGroup;
    use crate::api::service_api::{
    ...
    use crate::source::source_search::{SearchControl, SearchError};
    use crate::source::source_view::{ContentCandidate, Position, Provenance};
    ...
    async fn heap_progress_forwarding_is_command_scoped_and_flushes_final_update() {
        use crate::debugger::cdp_runtime::HeapSnapshotStreamProgress;
  ...
  return true;
    ...
    fn heap_capture_records_only_cheap_script_provenance() {
        ...
        let mut script = ScriptState {
            ...
            source: ScriptSourceState::Unresolved,
            provenance: Default::default(),
            captured_source: Some(crate::debugger::debugger_engine::CapturedScriptSource {
                content: Arc::from("large generated source"),
                source_map: Some(crate::source::source_view::SourceMapData::new(
        ...
        source.source_map = Some(crate::source::source_view::SourceMapData::new(large_map.into_bytes()));
    ...
    fn anonymous_frames_are_identified_as_callbacks_of_the_authored_container() {
        ...
        assert_eq!(
            callback_aware_breadcrumb(
                crate::source::language_intelligence::breadcrumb("bundle.js", generated, 1, column,),
                "",
            ),
