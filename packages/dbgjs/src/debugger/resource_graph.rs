...
//! 2. A capability is a callable object (see [`crate::api::capability`]), never a boolean. The
...
use crate::connection::discovery::{DiscoveryState, FrontierDeclaration};
...
impl SharedResourceGraph {
    ...
    /// Reads the graph under the lock, e.g. to resolve a [`crate::debugger::scope::Scope`] or to fetch a
...
mod tests {
    use super::*;
    use crate::api::capability::testing::{FakeExplore, FakeProcess};
    use serde_json::json;
