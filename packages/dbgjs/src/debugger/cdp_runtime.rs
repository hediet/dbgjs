...
use crate::debugger::debugger_engine::{Effect, Input, RawFrame, RawScope, SessionKey, StepKind};
use crate::connection::transport::session_transport::{CdpSessionMux, RawCdpSession};
use crate::source::source_view::{Position, SourceMapData};
use crate::connection::transport::websocket_transport::{CdpWebSocketError, CdpWebSocketTransport};
    ...
    pub async fn execute(&self, effect: &Effect) -> Result<Option<Input>, CdpRuntimeError> {
        match effect {
            ...
            Effect::InstallBreakpoint {
                ...
                let confirmed_position = crate::source::source_view::Position {
