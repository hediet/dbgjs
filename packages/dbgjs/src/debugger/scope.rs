...
use crate::api::capability::CapabilityKind;
use crate::connection::discovery::DiscoveryState;
use crate::debugger::resource_graph::{EdgeDirection, RelationKind, ResourceGraph, ResourceId, ResourceKind};
...
mod tests {
    ...
    use super::*;
    use crate::api::capability::CapabilityObject;
    use crate::api::capability::testing::{FakeBrowser, FakeFrame, FakeProcess};
