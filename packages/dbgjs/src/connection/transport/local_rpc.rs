...
use crate::api::service_api::{self, DbgServiceClient, ServiceApi};
...
pub enum LocalRpcError {
    ...
    Random(String),
    #[error(transparent)]
    Persistence(#[from] crate::service::debugger_service::ServicePersistenceError),
...
mod tests {
    ...
    async fn service_facets_share_state_and_route_over_native_local_ipc() {
        ...
        assert_eq!(
            ...
            crate::api::service_api::BreakpointStatus::Pending
        );
