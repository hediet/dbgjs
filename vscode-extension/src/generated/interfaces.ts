...
import { applicationError, bareInterfaceTarget, defaultInterfaceTarget, interfaceTarget, InterfaceDefinition, notificationType, requestType, type BareInterfaceTarget, type DefaultInterfaceTarget, type QualifiedInterfaceTarget, type LinkRpcInterfaceSchema } from "@hediet/linkrpc";
import { z } from "zod";
...
namespace $contract5 {
    ...
    const wireSchema: LinkRpcInterfaceSchema = JSON.parse("{\"id\":\"dev.dbgjs.coverage\",\"hash\":\"1114f19cd3ff605e\",\"methods\":{\"finish_coverage\":{\"params\":{\"type\":\"object\",\"required\":[\"targetRef\"],\"properties\":{\"captureId\":{\"type\":[\"string\",\"null\"]},\"targetRef\":{\"$ref\":\"#/components/schemas/TargetRef\"}},\"additionalProperties\":false},\"result\":{\"type\":\"boolean\"}},\"get_coverage\":{\"params\":{\"type\":\"object\",\"required\":[\"captureId\",\"noCache\",\"targetRef\"],\"properties\":{\"captureId\":{\"type\":\"string\"},\"noCache\":{\"type\":\"boolean\"},\"sourcePath\":{\"type\":[\"string\",\"null\"]},\"targetRef\":{\"$ref\":\"#/components/schemas/TargetRef\"}},\"additionalProperties\":false},\"result\":{\"$ref\":\"#/components/schemas/CoverageSnapshot\"}},\"start_coverage\":{\"params\":{\"type\":\"object\",\"required\":[\"targetRef\"],\"properties\":{\"targetRef\":{\"$ref\":\"#/components/schemas/TargetRef\"}},\"additionalProperties\":false},\"result\":{\"type\":\"boolean\"}},\"stop_coverage\":{\"params\":{\"type\":\"object\",\"required\":[\"targetRef\"],\"properties\":{\"captureId\":{\"type\":[\"string\",\"null\"]},\"targetRef\":{\"$ref\":\"#/components/schemas/TargetRef\"}},\"additionalProperties\":false},\"result\":{\"$ref\":\"#/components/schemas/CoverageSnapshot\"}},\"take_coverage\":{\"params\":{\"type\":\"object\",\"required\":[\"targetRef\"],\"properties\":{\"captureId\":{\"type\":[\"string\",\"null\"]},\"raw\":{\"type\":[\"boolean\",\"null\"]},\"targetRef\":{\"$ref\":\"#/components/schemas/TargetRef\"}},\"additionalProperties\":false},\"result\":{\"$ref\":\"#/components/schemas/CoverageSnapshot\"}}},\"components\":{\"schemas\":{\"ConnectionRef\":{\"type\":\"object\",\"required\":[\"connectionId\",\"contextId\"],\"properties\":{\"connectionId\":{\"type\":\"string\"},\"contextId\":{\"type\":\"string\"}},\"additionalProperties\":false},\"CoverageAnalysisSnapshot\":{\"type\":\"object\",\"required\":[\"durationMicros\",\"sourceMapCacheBypasses\",\"sourceMapCacheHits\",\"sourceMapCacheMisses\"],\"properties\":{\"durationMicros\":{\"type\":\"integer\"},\"sourceMapCacheBypasses\":{\"type\":\"integer\"},\"sourceMapCacheHits\":{\"type\":\"integer\"},\"sourceMapCacheMisses\":{\"type\":\"integer\"}},\"additionalProperties\":false},\"CoverageFunctionSnapshot\":{\"type\":\"object\",\"required\":[\"blockCoverage\",\"name\",\"ranges\",\"rootEndOffset\",\"rootStartOffset\"],\"properties\":{\"authoredLocation\":{\"anyOf\":[{\"$ref\":\"#/components/schemas/SourceLocation\"},{\"type\":\"null\"}]},\"blockCoverage\":{\"type\":\"boolean\"},\"breadcrumb\":{\"type\":[\"string\",\"null\"]},\"effectiveRanges\":{\"type\":\"array\",\"items\":{\"$ref\":\"#/components/schemas/CoverageRangeSnapshot\"}},\"generatedLocation\":{\"anyOf\":[{\"$ref\":\"#/components/schemas/SourceLocation\"},{\"type\":\"null\"}]},\"name\":{\"type\":\"string\"},\"ranges\":{\"type\":\"array\",\"items\":{\"$ref\":\"#/components/schemas/CoverageRangeSnapshot\"}},\"rootEndOffset\":{\"type\":\"integer\"},\"rootStartOffset\":{\"type\":\"integer\"}},\"additionalProperties\":false},\"CoverageRangeSnapshot\":{\"type\":\"object\",\"required\":[\"count\",\"endOffset\",\"startOffset\"],\"properties\":{\"authoredEnd\":{\"anyOf\":[{\"$ref\":\"#/components/schemas/SourceLocation\"},{\"type\":\"null\"}]},\"authoredStart\":{\"anyOf\":[{\"$ref\":\"#/components/schemas/SourceLocation\"},{\"type\":\"null\"}]},\"count\":{\"type\":\"integer\"},\"endOffset\":{\"type\":\"integer\"},\"startOffset\":{\"type\":\"integer\"}},\"additionalProperties\":false},\"CoverageSnapshot\":{\"type\":\"object\",\"required\":[\"sources\",\"timestampMicros\"],\"properties\":{\"analysis\":{\"anyOf\":[{\"$ref\":\"#/components/schemas/CoverageAnalysisSnapshot\"},{\"type\":\"null\"}]},\"captureId\":{\"type\":[\"string\",\"null\"]},\"sources\":{\"type\":\"array\",\"items\":{\"$ref\":\"#/components/schemas/CoverageSourceSnapshot\"}},\"timestampMicros\":{\"type\":\"integer\"}},\"additionalProperties\":false},\"CoverageSourceSnapshot\":{\"type\":\"object\",\"required\":[\"functions\",\"generatedUrl\",\"scriptId\"],\"properties\":{\"associatedAuthoredSource\":{\"type\":[\"string\",\"null\"]},\"functions\":{\"type\":\"array\",\"items\":{\"$ref\":\"#/components/schemas/CoverageFunctionSnapshot\"}},\"generatedUrl\":{\"type\":\"string\"},\"scriptId\":{\"type\":\"string\"}},\"additionalProperties\":false},\"SourceLocation\":{\"type\":\"object\",\"required\":[\"column\",\"line\",\"sourceUrl\"],\"properties\":{\"column\":{\"type\":\"integer\"},\"line\":{\"type\":\"integer\"},\"sourceUrl\":{\"type\":\"string\"}},\"additionalProperties\":false},\"TargetRef\":{\"type\":\"object\",\"required\":[\"connection\",\"targetId\"],\"properties\":{\"connection\":{\"$ref\":\"#/components/schemas/ConnectionRef\"},\"targetId\":{\"type\":\"string\"}},\"additionalProperties\":false}}}}");
    
    export const definition = new InterfaceDefinition(
        {
            id: "dev.dbgjs.coverage",
            hash: "1114f19cd3ff605e",
        },
        {
...
namespace $contract9 {
    ...
    const SourceSearchOptionsSchema = z.object({
        ...
        contextLines: z.int(),
        maxResults: z.int(),
        noSourcemaps: z.boolean().optional(),
        path: z.union([
            z.string(),
            z.null(),
        ]).optional(),
