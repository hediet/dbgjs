...
use crate::object_inspection::{ObjectLocationSnapshot, ObjectSourceSnapshot, unresolved_position};
use crate::service_api::{HeapMappingSnapshot, HeapScriptSnapshot};
...
pub(crate) struct HeapSourceResolver {
    ...
    symbol_indexes: BTreeMap<String, crate::source_location::SymbolIndexCache>,
}
...
impl HeapSourceResolver {
    ...
    pub fn resolve(
        ...
        script_id: &str,
        position: Position,
    ) -> crate::source_location::ResolvedSourcePosition {
        ...
        match view {
            Ok(view) => {
                let mut resolved = crate::source_location::resolve_source_position(
                    view,
                    &script.url,
...
mod tests {
    ...
    use crate::service_api::HeapMappingStatus;
