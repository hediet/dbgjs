...
```console
$ dbgjs connection add ws://127.0.0.1:55706/devtools/browser/c6553fb9-a58c-4745-9d90-f6097c8b5f5d --context :playwright-e2e --connection browser --connect
  ...
  Connections:
    browser  [connected to Chrome/152.0.7977.65; CDP 1.3; generation 1]
      ...
      Targets:
        ...
        dbgjs Playwright E2E  dbgjs Playwright E2E  http://127.0.0.1:55705/  [a CDP client is attached]
...
```console
$ dbgjs page playwright --eval "await page.mouse.wheel(0, 800)" --context :playwright-e2e --connection browser --target 27C0DC8614E13113CCEAD319493065AB

```

```console
$ dbgjs page playwright --eval "return { title: await page.title(), scrollY: await page.evaluate(() => scrollY) };" --context :playwright-e2e --connection browser --target 27C0DC8614E13113CCEAD319493065AB
{
...
```console
$ dbgjs page playwright - --context :playwright-e2e --connection browser --target 27C0DC8614E13113CCEAD319493065AB <<'JS'
...
```console
$ dbgjs page playwright --eval "return { text: await page.frameLocator(\"#oopif\").locator(\"#oopif-marker\").textContent() };" --context :playwright-e2e --connection browser --target 27C0DC8614E13113CCEAD319493065AB
{
...
```console
$ dbgjs page playwright --eval "<pending page.evaluate>" --context :playwright-e2e --connection browser --target 27C0DC8614E13113CCEAD319493065AB
